...
import com.akp.janupkar.basic.Registration;
...
public class GuarantorDetailsActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void MemberGaranterAdd() {
        ...
        String url = "http://janupkarmicroapi.signaturesoftware.org/Service/MemberGaranterAdd";
        Log.v("#####", url);
    ...
    private void parseJsonloandetails(JSONObject response) {
        ...
        try {
            ...
            if (status.equals("true")) {
                ...
                startActivity(new Intent(mActivity, Registration.class));
                finish();;
