...
public class LoanRepaymentPageAdd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loan_repayment_page_add);
        ...
        if (wifi.isConnected())
        {
            ...
            mWebView.setWebChromeClient(new WebChromeClient() {
                ...
                public boolean onShowFileChooser(
                    ...
                    if (takePictureIntent.resolveActivity(LoanRepaymentPageAdd.this.getPackageManager()) != null) {
            ...
            //REMOTE RESOURCE
            mWebView.loadUrl("http://goldmaxcredit.org/App/MemberKYCUpdateapp?RoleId=4&BranchCode=101&UserCode="+UserId);
        }
