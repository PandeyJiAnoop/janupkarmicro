...
public class RegistrationPageAdd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registration_page_add);
...
// For API level below 18 (This method was deprecated in API level 18)
            ...
            mWebView.setWebChromeClient(new WebChromeClient() {
                ...
                public boolean onShowFileChooser(
                    ...
                    if (takePictureIntent.resolveActivity(RegistrationPageAdd.this.getPackageManager()) != null) {
            ...
            //REMOTE RESOURCE
            mWebView.loadUrl("http://goldmaxcredit.org/App/NewMemberRegistrationapp?RoleId=4&BranchCode=101&UserCode="+UserId);
