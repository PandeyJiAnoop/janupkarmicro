package com.akp.janupkar.utils;
...
import com.akp.janupkar.common.RuntimePermissionHelper;
...
public class AppUtils {
    ...
    public static void changeIconColor(ImageView imageView, Context context, int color) {
        imageView.setColorFilter(context.getResources().getColor(color), Mode.SRC_IN);
    }
