...
public class MemberhouseHoldNextWebview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_memberhouse_hold_next_webview);
        ...
        if (wifi.isConnected())
        {
            ...
            mWebView.setWebChromeClient(new WebChromeClient() {
                ...
                public boolean onShowFileChooser(
                    ...
                    if (takePictureIntent.resolveActivity(MemberhouseHoldNextWebview.this.getPackageManager()) != null) {
            ...
            //REMOTE RESOURCE
            mWebView.loadUrl("http://goldmaxcredit.org/App/MemberHousehold_Second?UserName="+UserId+"&LoanNo="+GetPerformano+"&MemberId="+GetId);
        }
