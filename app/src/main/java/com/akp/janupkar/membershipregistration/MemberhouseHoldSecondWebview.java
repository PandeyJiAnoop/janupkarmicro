...
public class MemberhouseHoldSecondWebview extends AppCompatActivity {
    ...
    String UserId,GetPerformano,GetId;
    ImageView menuImg;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_memberhouse_hold_second_webview);
        ...
        if (wifi.isConnected())
        {
            ...
            mWebView.setWebChromeClient(new WebChromeClient() {
                ...
                public boolean onShowFileChooser(
                    ...
                    if (takePictureIntent.resolveActivity(MemberhouseHoldSecondWebview.this.getPackageManager()) != null) {
            ...
            //REMOTE RESOURCE
            mWebView.loadUrl("http://goldmaxcredit.org/App/MemberHousehold_SecondReport?UserName="+UserId+"&LoanNo="+GetPerformano+"&MemberId="+GetId);
        }
