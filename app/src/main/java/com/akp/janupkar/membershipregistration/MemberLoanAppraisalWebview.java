...
public class MemberLoanAppraisalWebview extends AppCompatActivity {
    ...
    String UserId,GetPerformano;
    ImageView menuImg;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_member_loan_appraisal_webview);
        ...
        if (wifi.isConnected())
        {
            ...
            mWebView.setWebChromeClient(new WebChromeClient() {
                ...
                public boolean onShowFileChooser(
                    ...
                    if (takePictureIntent.resolveActivity(MemberLoanAppraisalWebview.this.getPackageManager()) != null) {
            ...
            //REMOTE RESOURCE
            mWebView.loadUrl("http://goldmaxcredit.org/App/MemberLoanAppraisal?UserName="+UserId+"&ProfarmaNo="+GetPerformano);
        }
